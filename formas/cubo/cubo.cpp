    ...
    switch(renderType){
        ...
        case 2: 
            ...
            for( int i = 0 ; i < 24 ; i++ ){
                ...
                ori[0] = camera->posicao.x;
                ori[1] = camera->posicao.y;
                ori[2] = camera->posicao.z;

                Ponto3 came = camera->posicao;
                Ponto3 po[2] = {came, posicao};
                cout << came << endl;
                
                
                Ponto* proj = camera->projetar(po, 2);
                window.desenha(ca, proj[1]);
